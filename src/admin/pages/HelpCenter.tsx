...
import HelpSvg from "../../core/assets/help.svg";
import SvgContainer from "../../core/components/SvgContainer";
import AdminAppBar from "../components/AdminAppBar";
import AdminToolbar from "../components/AdminToolbar";
import { Container, Grid, Card, CardActionArea, CardHeader, Avatar, CardContent, Badge, Typography } from "@mui/material";
      ...
      <Grid container spacing={2} sx={{ mt: 3 }}>
        ...
        <Grid item xs={6} lg={3}>
          <Card>
            <CardActionArea
              component="a"
              href={`mailto:${import.meta.env.VITE_APP_CONTACT_MAIL}`}
            >
              <CardHeader
                avatar={
